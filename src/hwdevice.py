...
class HWdevice(QObject):
    ...
    def prepare_transfer_tx(self, caller, bip32_path,  utxos_to_spend, dest_address, tx_fee, useSwiftX=False, isTestnet=False, stakerAddress=""):
        rewardsArray = []
        mnode = {}
        mnode['path'] = bip32_path
        mnode['utxos'] = utxos_to_spend
        rewardsArray.append(mnode)
        self.prepare_transfer_tx_bulk(caller, rewardsArray, dest_address, tx_fee, useSwiftX, isTestnet, stakerAddress)
    ...
    def prepare_transfer_tx_bulk(self, caller, rewardsArray, dest_address, tx_fee, useSwiftX=False, isTestnet=False, stakerAddress=""):
        ...
        self.api.prepare_transfer_tx_bulk(caller, rewardsArray, dest_address, tx_fee, useSwiftX, isTestnet, stakerAddress)
